...
const keyHash =
  "0508bed9fd4f78f10478c995115fdf0b087b42d661e8c6f27710c035187b029b";
...
module.exports = async function (deployer, network, accounts) {
  if (network === "development") {
    ...
    const cardinal = await deployProxy(
      Cardinal,
      [
        keyHash,
        corToken.address,
    ...
    await cardinal.setMaxRewardCor(1, 20);
    await cardinal.setMaxRewardExp(1, 5);

    await corToken.transferFrom(
      corToken.address,
      accounts[1],
